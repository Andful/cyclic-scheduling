...
# -*- coding: utf-8 -*-
#
# cyclic_scheduling documentation build configuration file
#
...
project = 'cyclic_scheduling'
copyright = '2023, Andrea Nardi'
author = 'Andrea Nardi'
...
_version_py = os.path.join(repo, 'cyclic_scheduling', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'cyclic_schedulingdoc'
...
latex_documents = [
    (master_doc, 'cyclic_scheduling.tex', 'cyclic_scheduling Documentation',
     'Andrea Nardi', 'manual'),
]
...
man_pages = [
    (master_doc,
    'cyclic_scheduling',
    'cyclic_scheduling Documentation',
     [author], 1)
]
